...
// NewInfluxdbBucketAPI creates a new bucket API wrapper
func NewInfluxdbBucketAPI(api api.BucketsAPI) bucket {
	return &influxdbBucketAPI{api: api}
}
